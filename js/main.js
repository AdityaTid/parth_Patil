...
!function(o) {
    ...
    o(document).ready(function() {
        ...
        o(".slider-fade").on("changed.owl.carousel", function(e) {
            ...
            o(".owl-item").not(".cloned").eq(e).find("h1").addClass("animated fadeInUp"),
            o(".owl-item").not(".cloned").eq(e).find(".subheading").addClass("animated fadeInUp"),
            o(".owl-item").not(".cloned").eq(e).find("p").addClass("animated fadeInUp"),
            o(".owl-item").not(".cloned").eq(e).find("a").addClass("animated fadeInUp")
        }),
        o(".countup").counterUp({
            delay: 25,
            time: 2e3
