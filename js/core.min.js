!function(s) {
    ...
    s.fn.menumaker = function(t) {
        ...
        return this.each(function() {
            ...
            e.find(".navbar-nav > li.has-sub > .submenu-button").on("click", function() {
                ...
                s(this).parents(".navbar-nav > li.has-sub").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active")
            }),
            e.find(".sub-menu > li.has-sub > .submenu-button").on("click", function() {
                s(this).next(".sub-menu").slideToggle(),
                s(this).siblings("ul").addClass("open").slideToggle(),
                s(this).parents(".sub-menu > li").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active"),
                s(this).siblings("ul").hasClass("open") && s(this).parents("li").eq(1).addClass("active")
            })) : e.addClass("dropdown"),
    ...
    s(document).ready(function() {
        s("header nav").menumaker({
            format: "multitoggle"
        });
        var t = window.location.pathname.split("/")
          , e = window.location.pathname
          , e = 0 < t[t.length - 1].length ? t[t.length - 1] : t[t.length - 2];
        s(".navbar-nav li").find('a[href="' + e + '"]').closest("li").addClass("active").parents().eq(1).addClass("current"),
        s(".navbar-nav li.has-sub ul li").find('a[href="' + e + '"]').parents().eq(4).addClass("current")
    }),
    s(".navbar-default .attr-nav").each(function() {
        s("li.search > a", this).on("click", function(t) {
            t.preventDefault(),
            s(".top-search").slideToggle()
        })
    }),
...
function(l, i, s, a) {
    ...
    c.Workers = [{
        ...
        run: function() {
            for (var t, e, i = this.settings.rtl ? 1 : -1, s = 2 * this.settings.stagePadding, o = this.coordinates(this.current()) + s, n = o + this.width() * i, r = [], a = 0, l = this._coordinates.length; a < l; a++)
                ...
                (this.op(t, "<=", o) && this.op(t, ">", n) || this.op(e, "<", o) && this.op(e, ">", n)) && r.push(a);
    ...
    c.prototype.onDragMove = function(t) {
        var e, i = null, s = null, o = this.difference(this._drag.pointer, this.pointer(t)), n = this.difference(this._drag.stage.start, o);
        this.is("dragging") && (t.preventDefault(),
        this.settings.loop ? (i = this.coordinates(this.minimum()),
        s = this.coordinates(this.maximum() + 1) - i,
        n.x = ((n.x - i) % s + s) % s + i) : (i = this.settings.rtl ? this.coordinates(this.maximum()) : this.coordinates(this.minimum()),
    ...
    c.prototype.closest = function(i, s) {
        ...
        return this.settings.freeDrag || l.each(r, l.proxy(function(t, e) {
            return "left" === s && e - 30 < i && i < e + 30 ? o = t : "right" === s && e - n - 30 < i && i < e - n + 30 ? o = t + 1 : this.op(i, "<", e) && this.op(i, ">", r[t + 1] !== a ? r[t + 1] : e - n) && (o = "left" === s ? t + 1 : t),
            -1 === o
        }, this)),
    ...
    c.prototype.to = function(t, e) {
        var i, s = this.current(), o = t - this.relative(s), n = (0 < o) - (o < 0), r = this._items.length, a = this.minimum(), l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(o) > r / 2 && (o += -1 * n * r),
        (i = (((t = s + o) - a) % r + r) % r + a) !== t && i - o <= l && 0 < i - o && (s = i - o,
        t = i,
        this.reset(s))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(a, Math.min(l, t)),
...
function(h, e) {
    ...
    i.prototype.thumbnail = function(e, t) {
        ...
        var s, o, n = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "", r = e.find("img"), a = "src", l = "", c = this._core.settings;
        if (e.wrap(h("<div/>", {
    ...
    i.prototype.play = function(t) {
        ...
        (t = h('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", o),
        t.attr("width", s),
        "youtube" === i.type ? t.attr("src", "//www.youtube.com/embed/" + i.id + "?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? t.attr("src", "//player.vimeo.com/video/" + i.id + "?autoplay=1") : "vzaar" === i.type && t.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"),
        h(t).wrap('<div class="owl-video-frame" />').insertAfter(e.find(".owl-video")),
...
function(s, o, e) {
    ...
    i.prototype._next = function(t) {
        this._call = o.setTimeout(s.proxy(this._next, this, t), this._timeout * (Math.round(this.read() / this._timeout) + 1) - this.read()),
...
function(o) {
    ...
    e.prototype.update = function() {
        var t, e, i = this._core.clones().length / 2, s = i + this._core.items().length, o = this._core.maximum(!0), n = this._core.settings, r = n.center || n.autoWidth || n.dotsData ? 1 : n.dotsEach || n.items;
    ...
    e.prototype.draw = function() {
        ...
        t.dots && (e = this._pages.length - this._controls.$absolute.children().length,
        t.dotsData && 0 != e ? this._controls.$absolute.html(this._templates.join("")) : 0 < e ? this._controls.$absolute.append(new Array(1 + e).join(this._templates[0])) : e < 0 && this._controls.$absolute.children().slice(e).remove(),
...
function(s, o) {
    ...
    var e = function(t) {
        ...
        this.$element.on(this._handlers),
        s(o).on("hashchange.owl.navigation", s.proxy(function(t) {
...
function(o, n) {
    ...
    s() && (o.support.animation = new String(c("animation")),
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            var l = i(this)
              , c = e;
            l.waypoint(function() {
                for (var t = [], e = c.time / c.delay, i = l.text(), s = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), o = (/^[0-9]+$/.test(i),
                /^[0-9]+\.[0-9]+$/.test(i)), n = o ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
                    var a = parseInt(i / e * r);
                    if (o && (a = parseFloat(i / e * r).toFixed(n)),
                    s)
...
function() {
    ...
    var s, t, i, l, o, r = [].indexOf || function(t) {
    ...
    ,
    h.prototype.createEvent = function(t, e, i, s) {
        var o;
        return null == e && (e = !1),
        null == i && (i = !1),
        null == s && (s = null),
        null != document.createEvent ? (o = document.createEvent("CustomEvent")).initCustomEvent(t, e, i, s) : null != document.createEventObject ? (o = document.createEventObject()).eventType = t : o.eventName = t,
        o
    }
    ,
    ...
    ,
    t = h,
    i = this.WeakMap || this.MozWeakMap || (c.prototype.get = function(t) {
        for (var e, i, s = e = 0, o = (i = this.keys).length; e < o; s = ++e)
            if (i[s] === t)
                return this.values[s]
    }
    ,
    c.prototype.set = function(t, e) {
        for (var i, s, o = i = 0, n = (s = this.keys).length; i < n; o = ++i)
            if (s[o] === t)
    ...
    ,
    c),
    s = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (a.notSupported = !0,
    ...
    n.prototype.start = function() {
        ...
        if (this.stopped = !1,
        this.boxes = function() {
            for (var t, e = [], i = 0, s = (t = this.element.querySelectorAll("." + this.config.boxClass)).length; i < s; i++)
                o = t[i],
                e.push(o);
            return e
        }
        .call(this),
        this.all = function() {
            for (var t, e = [], i = 0, s = (t = this.boxes).length; i < s; i++)
                o = t[i],
                e.push(o);
            return e
        }
        ...
        this.boxes.length)
            if (this.disabled())
                ...
                for (t = 0,
                e = (i = this.boxes).length; t < e; t++)
                    o = i[t],
                    this.applyStyle(o, !0);
        return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler),
        this.util().addEvent(window, "resize", this.scrollHandler),
        this.interval = setInterval(this.scrollCallback, 50)),
        this.config.live ? new s((r = this,
        function(t) {
            for (var o, n, e = [], i = 0, s = t.length; i < s; i++)
                n = t[i],
                e.push(function() {
                    for (var t, e = [], i = 0, s = (t = n.addedNodes || []).length; i < s; i++)
                        o = t[i],
    ...
    n.prototype.doSync = function(t) {
        ...
        1 === t.nodeType) {
            for (n = [],
            i = 0,
            s = (o = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; i < s; i++)
                e = o[i],
    ...
    n.prototype.applyStyle = function(t, e) {
        var i, s = t.getAttribute("data-wow-duration"), o = t.getAttribute("data-wow-delay"), n = t.getAttribute("data-wow-iteration");
        return this.animate((i = this,
        function() {
    ...
    n.prototype.resetStyle = function() {
        for (var t, e, i = [], s = 0, o = (e = this.boxes).length; s < o; s++)
            t = e[s],
            i.push(t.style.visibility = "visible");
        return i
    }
    ,
    ...
    n.prototype.vendorSet = function(o, t) {
        ...
        for (n in t)
            ...
            o["" + n] = r,
            e.push(function() {
                for (var t, e = [], i = 0, s = (t = this.vendors).length; i < s; i++)
                    a = t[i],
                    e.push(o["" + a + n.charAt(0).toUpperCase() + n.substr(1)] = r);
                return e
            }
            .call(this));
        return e
    ...
    n.prototype.vendorCSS = function(t, e) {
        for (var i, s, o, n = (s = l(t)).getPropertyCSSValue(e), r = 0, a = (i = this.vendors).length; r < a; r++)
            o = i[r],
    ...
    n.prototype.scrollCallback = function() {
        ...
        this.boxes = function() {
            for (var t, e = [], i = 0, s = (t = this.boxes).length; i < s; i++)
                (o = t[i]) && (this.isVisible(o) ? this.show(o) : e.push(o));
            return e
        }
        .call(this),
...
function(g, o, t, f) {
    var s = "stellar"
      ...
      , n = function() {
        ...
        return "WebkitOpacity"in i && (s = "Webkit"),
    ...
    c.prototype = {
        ...
        _defineElements: function() {
            ...
            this.$viewportElement = this.options.viewportElement !== f ? g(this.options.viewportElement) : this.$scrollElement[0] === o || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        _defineSetters: function() {
            ...
            : g.noop,
            this._setPosition = r.setPosition || function(t, e, i, s, o) {
        ...
        _findParticles: function() {
            ...
            if (this.particles !== f)
                for (var t = this.particles.length - 1; 0 <= t; t--)
                    this.particles[t].$element.data("stellar-elementIsActive", f);
            this.particles = [],
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                var e, i, s, o, n, r, a, l = g(this), c = 0, h = 0, d = 0, u = 0;
                ...
                l.data("stellar-startingLeft") ? (l.css("left", l.data("stellar-startingLeft")),
                l.css("top", l.data("stellar-startingTop"))) : (l.data("stellar-startingLeft", l.css("left")),
                l.data("stellar-startingTop", l.css("top"))),
                e = l.position().left,
                i = l.position().top,
                s = "auto" === l.css("margin-left") ? 0 : parseInt(l.css("margin-left"), 10),
                o = "auto" === l.css("margin-top") ? 0 : parseInt(l.css("margin-top"), 10),
                r = l.offset().left - s,
                a = l.offset().top - o,
                ...
                s = l.data("stellar-horizontal-offset") !== f ? l.data("stellar-horizontal-offset") : n !== f && n.data("stellar-horizontal-offset") !== f ? n.data("stellar-horizontal-offset") : p.horizontalOffset,
                o = l.data("stellar-vertical-offset") !== f ? l.data("stellar-vertical-offset") : n !== f && n.data("stellar-vertical-offset") !== f ? n.data("stellar-vertical-offset") : p.verticalOffset,
                p.particles.push({
                    $element: l,
                    $offsetParent: n,
        ...
        _findBackgrounds: function() {
            var t, d = this, u = this._getScrollLeft(), p = this._getScrollTop();
            this.backgrounds = [],
            ...
            t.each(function() {
                var t, e, i, s, o, n = g(this), r = v(n), a = 0, l = 0, c = 0, h = 0;
                if (n.data("stellar-backgroundIsActive")) {
                    if (n.data("stellar-backgroundIsActive") !== this)
                        return
                } else
                    n.data("stellar-backgroundIsActive", this);
                n.data("stellar-backgroundStartingLeft") ? m(n, n.data("stellar-backgroundStartingLeft"), n.data("stellar-backgroundStartingTop")) : (n.data("stellar-backgroundStartingLeft", r[0]),
                n.data("stellar-backgroundStartingTop", r[1])),
                t = "auto" === n.css("margin-left") ? 0 : parseInt(n.css("margin-left"), 10),
                e = "auto" === n.css("margin-top") ? 0 : parseInt(n.css("margin-top"), 10),
                i = n.offset().left - t - u,
                s = n.offset().top - e - p,
                ...
                t = n.data("stellar-horizontal-offset") !== f ? n.data("stellar-horizontal-offset") : o !== f && o.data("stellar-horizontal-offset") !== f ? o.data("stellar-horizontal-offset") : d.horizontalOffset,
                e = n.data("stellar-vertical-offset") !== f ? n.data("stellar-vertical-offset") : o !== f && o.data("stellar-vertical-offset") !== f ? o.data("stellar-vertical-offset") : d.verticalOffset,
                d.backgrounds.push({
                    $element: n,
                    $offsetParent: o,
        ...
        _repositionElements: function() {
            var t, e, i, s, o, n, r, a, l, c, h = this._getScrollLeft(), d = this._getScrollTop(), u = !0, p = !0;
            if (this.currentScrollLeft !== h || this.currentScrollTop !== d || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                ...
                c = this.particles.length - 1; 0 <= c; c--)
                    ...
                    a = this.options.horizontalScrolling ? (n = (h + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft) - t.startingPositionLeft + t.startingOffsetLeft : (n = t.startingPositionLeft,
                    t.startingOffsetLeft),
                    l = this.options.verticalScrolling ? (r = (d + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop) - t.startingPositionTop + t.startingOffsetTop : (r = t.startingPositionTop,
                    t.startingOffsetTop),
                    this.options.hideDistantElements && (p = !this.options.horizontalScrolling || a + t.width > (t.isFixed ? 0 : h) && a < (t.isFixed ? 0 : h) + this.viewportWidth + this.viewportOffsetLeft,
                    u = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : d) && l < (t.isFixed ? 0 : d) + this.viewportHeight + this.viewportOffsetTop),
                    p && u ? (t.isHidden && (this.options.showElement(t.$element),
                    t.isHidden = !1),
    ...
    g.fn[s] = function(e) {
        ...
        return e === f || "object" == typeof e ? this.each(function() {
            ...
            "destroy" === e && g.data(this, "plugin_" + s, null)
        }) : void 0
    }
    ,
    g[s] = function(t) {
    ...
    i.prototype.handleScroll = function() {
        ...
        for (t in s) {
            ...
            for (o in this.waypoints[t]) {
                ...
                null !== c.triggerPoint && (a = n.oldScroll < c.triggerPoint,
                l = n.newScroll >= c.triggerPoint,
                (a && l || !a && !l) && (c.queueTrigger(r),
    ...
    i.prototype.refresh = function() {
        ...
        t = {
            ...
            for (n in this.waypoints[e]) {
                var a, l = this.waypoints[e][n], c = l.options.offset, h = l.triggerPoint, d = 0, u = null == h;
                l.element !== l.element.window && (d = l.adapter.offset()[r.offsetProp]),
                "function" == typeof c ? c = c.apply(l) : "string" == typeof c && (c = parseFloat(c),
                -1 < l.options.offset.indexOf("%") && (c = Math.ceil(r.contextDimension * c / 100))),
                a = r.contextScroll - r.contextOffset,
                l.triggerPoint = Math.floor(d + a - c),
                a = h < r.oldScroll,
                c = l.triggerPoint >= r.oldScroll,
                h = !a && !c,
                !u && (a && c) ? (l.queueTrigger(r.backward),
                o[l.group.id] = l.group) : (!u && h || u && r.oldScroll >= l.triggerPoint) && (l.queueTrigger(r.forward),
...
function() {
    ...
    function t(s) {
        return function() {
            var e = []
              , i = arguments[0];
            return s.isFunction(arguments[0]) && ((i = s.extend({}, arguments[1])).handler = arguments[0]),
            this.each(function() {
                var t = s.extend({}, i, {
                    element: this
                });
                "string" == typeof t.context && (t.context = s(this).closest(t.context)[0]),
                e.push(new o(t))
            }),
            e
        }
...
function(c) {
    ...
    c.fn.countdown = function(t, n) {
        ...
        function e() {
            ...
            e = Math.floor(i / 60);
            i -= 60 * e,
            1 == s ? r.find(".timeRefDays").text("day") : r.find(".timeRefDays").text("days"),
            1 == o ? r.find(".timeRefHours").text("hour") : r.find(".timeRefHours").text("hours"),
            1 == e ? r.find(".timeRefMinutes").text("minute") : r.find(".timeRefMinutes").text("minutes"),
            1 == i ? r.find(".timeRefSeconds").text("second") : r.find(".timeRefSeconds").text("seconds"),
            "on" == a.format && (s = 2 <= String(s).length ? s : "0" + s,
            ...
            clearInterval(l)) : (r.find(".days").text(s),
            r.find(".hours").text(o),
...
function(t) {
    ...
    function d(t, e, i, s) {
        ...
        i && (o.innerHTML = i),
        s ? e && e.appendChild(o) : (o = c(o),
        e && o.appendTo(e)),
        o
    }
    function u(t, e) {
        g.ev.triggerHandler("mfp" + t, e),
        g.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1),
        g.st.callbacks[t] && g.st.callbacks[t].apply(g, c.isArray(e) ? e : [e]))
    }
    function p(t) {
        return t === e && g.currTemplate.closeBtn || (g.currTemplate.closeBtn = c(g.st.closeMarkup.replace("%title%", g.st.tClose)),
        e = t),
        g.currTemplate.closeBtn
    }
    function n() {
        c.magnificPopup.instance || ((g = new t).init(),
        c.magnificPopup.instance = g)
    }
    var g, s, f, o, m, e, l = "Close", v = "BeforeClose", y = "MarkupParse", w = "Open", b = ".mfp", x = "mfp-ready", i = "mfp-removing", r = "mfp-prevent-close", a = !!window.jQuery, _ = c(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            if (!1 === t.isObj) {
                g.items = t.items.toArray(),
                g.index = 0;
                for (var e, i = t.items, s = 0; s < i.length; s++)
                    if ((e = i[s]).parsed && (e = e.el[0]),
                    e === t.el[0]) {
                        g.index = s;
                        break
                    }
            ...
            if (!g.isOpen) {
                g.types = [],
                m = "",
                t.mainEl && t.mainEl.length ? g.ev = t.mainEl.eq(0) : g.ev = f,
                t.key ? (g.popupsCache[t.key] || (g.popupsCache[t.key] = {}),
                g.currTemplate = g.popupsCache[t.key]) : g.currTemplate = {},
                ...
                g.bgOverlay || (g.bgOverlay = d("bg").on("click" + b, function() {
                    g.close()
                }),
                ...
                u("BeforeOpen"),
                g.st.showCloseBtn && (g.st.closeBtnInside ? (h(y, function(t, e, i, s) {
                    i.close_replaceWith = p(s.type)
                }),
                m += " mfp-close-btn-in") : g.wrap.append(p())),
                ...
                g.st.enableEscapeKey && f.on("keyup" + b, function(t) {
                ...
                var r = g.wH = _.height()
                  , a = {};
                g.fixedContentPos && g._hasScrollBar(r) && ((l = g._getScrollbarSize()) && (a.marginRight = l)),
                g.fixedContentPos && (g.isIE7 ? c("body, html").css("overflow", "hidden") : a.overflow = "hidden");
                var l = g.st.mainClass;
                return g.isIE7 && (l += " mfp-ie7"),
                ...
                setTimeout(function() {
                    g.content ? (g._addClassToMFP(x),
                    g._setFocus()) : g.bgOverlay.addClass(x),
        ...
        close: function() {
            g.isOpen && (u(v),
            g.isOpen = !1,
            g.st.removalDelay && !g.isLowIE && g.supportsTransition ? (g._addClassToMFP(i),
            setTimeout(function() {
                g._close()
        ...
        _close: function() {
            ...
            g.isIE7 ? c("body, html").css("overflow", "") : t.overflow = "",
            c("html").css(t)),
            ...
            g.st.autoFocusLast && g._lastFocusedEl && c(g._lastFocusedEl).focus(),
            g.currItem = null,
            g.content = null,
            g.currTemplate = null,
            g.prevHeight = 0,
        ...
        updateSize: function(t) {
            var e;
            g.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth,
            e = window.innerHeight * e,
            g.wrap.css("height", e),
            g.wH = e) : g.wH = t || _.height(),
        ...
        updateItemHTML: function() {
            ...
            g.currItem = t,
            g.currTemplate[e] || (i = !!g.st[e] && g.st[e].markup,
        ...
        parseEl: function(t) {
            ...
            return i.type = e || g.st.type || "inline",
            i.index = t,
            i.parsed = !0,
            g.items[t] = i,
            u("ElementParse", i),
        ...
        updateStatus: function(t, e) {
            var i;
            g.preloader && (s !== t && g.container.removeClass("mfp-s-" + s),
        ...
        _checkIfClose: function(t) {
            if (!c(t).hasClass(r)) {
                ...
                if (e && i)
                    return !0;
                if (!g.content || c(t).hasClass("mfp-close") || g.preloader && t === g.preloader[0])
                    return !0;
        ...
        _addClassToMFP: function(t) {
            g.bgOverlay.addClass(t),
            g.wrap.addClass(t)
        },
        _removeClassFromMFP: function(t) {
            this.bgOverlay.removeClass(t),
            g.wrap.removeClass(t)
        },
        ...
        _onFocusIn: function(t) {
            return t.target === g.wrap[0] || c.contains(g.wrap[0], t.target) ? void 0 : (g._setFocus(),
            !1)
        },
        _parseMarkup: function(o, t, e) {
            ...
            c.each(t, function(t, e) {
                return void 0 === e || !1 === e || void (1 < (n = t.split("_")).length ? 0 < (i = o.find(b + "-" + n[0])).length && ("replaceWith" === (s = n[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === s ? i.is("img") ? i.attr("src", e) : i.replaceWith(c("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(n[1], e)) : o.find(b + "-" + t).html(e));
                var i, s
            })
        },
        _getScrollbarSize: function() {
            var t;
            return void 0 === g.scrollbarSize && ((t = document.createElement("div")).style.cssText = "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;",
    ...
    c.fn.magnificPopup = function(t) {
        n();
        var e, i, s, o = c(this);
        return "string" == typeof t ? "open" === t ? (e = a ? o.data("magnificPopup") : o[0].magnificPopup,
        i = parseInt(arguments[1], 10) || 0,
        s = e.items ? e.items[i] : (s = o,
        e.delegate && (s = s.find(e.delegate)),
        s.eq(i)),
        g._openClick({
            mfpEl: s
        }, o, e)) : g.isOpen && g[t].apply(g, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t),
        ...
        proto: {
            ...
            getInline: function(t, e) {
                ...
                t.src) {
                    ...
                    return o.length ? ((i = o[0].parentNode) && i.tagName && (T || ($ = s.hiddenClass,
                    T = d($),
                    $ = "mfp-" + $),
                    S = o.after(T).detach().removeClass($)),
                    g.updateStatus("ready")) : (g.updateStatus("error", s.tNotFound),
                    o = c("<div>")),
                    t.inlineElement = o
                }
            ...
            getAjax: function(s) {
                ...
                var t = c.extend({
                    ...
                    error: function() {
                        ...
                        g.updateStatus("error", g.st.ajax.tError.replace("%url%", s.src))
                    }
                }, g.st.ajax.settings);
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            resizeImage: function() {
                var t, e = g.currItem;
                e && e.img && g.st.image.verticalFit && (t = 0,
            ...
            _onImageHasSize: function(t) {
                ...
                u("ImageHasSize", t),
                t.imgHidden && (g.content && g.content.removeClass("mfp-loading"),
                t.imgHidden = !1))
            },
                ...
                var i = 0
                  ...
                  , o = function(t) {
                    ...
                    A = setInterval(function() {
                        return 0 < s.naturalWidth ? void g._onImageHasSize(e) : (200 < i && clearInterval(A),
            ...
            getImage: function(t, e) {
                var i, s = 0, o = function() {
                    ...
                    t === g.currItem && (g._onImageHasSize(t),
                    g.updateStatus("ready")),
                    t.hasSize = !0,
                    t.loaded = !0,
                    u("ImageLoadComplete")) : ++s < 200 ? setTimeout(o, 100) : n())
                }, n = function() {
                    t && (t.img.off(".mfploader"),
                    t === g.currItem && (g._onImageHasSize(t),
                    g.updateStatus("error", r.tError.replace("%url%", t.src))),
                    t.hasSize = !0,
                    t.loaded = !0,
                    t.loadError = !0)
    ...
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                r.enabled && g.supportsTransition && (s = r.duration,
                o = function(t) {
                    var e = t.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image")
                      ...
                      , t = "transition";
                    return s["-webkit-" + t] = s["-moz-" + t] = s["-o-" + t] = s[t] = i,
                    e.css(s),
                    e
                }
                ,
                ...
                h("BuildControls" + a, function() {
                    g._allowZoom() && (clearTimeout(e),
                    g.content.css("visibility", "hidden"),
                    (t = g._getItemToZoom()) ? ((i = o(t)).css(g._getOffset()),
                    g.wrap.append(i),
    ...
    function I(t) {
        var e;
        !g.currTemplate[L] || (e = g.currTemplate[L].find("iframe")).length && (t || (e[0].src = "//about:blank"),
        ...
        proto: {
            initGallery: function() {
                ...
                h("BuildControls" + t, function() {
                    var t, e;
                    1 < g.items.length && n.arrows && !g.arrowLeft && (e = n.arrowMarkup,
                    t = g.arrowLeft = c(e.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(r),
                    e = g.arrowRight = c(e.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(r),
                    t.click(function() {
                        g.prev()
                    }),
                    e.click(function() {
            ...
            preloadNearbyImages: function() {
                for (var t = g.st.gallery.preload, e = Math.min(t[0], g.items.length), i = Math.min(t[1], g.items.length), s = 1; s <= (g.direction ? i : e); s++)
            ...
            _preloadItem: function(t) {
                var e;
                t = q(t),
                g.items[t].preloaded || ((e = g.items[t]).parsed || (e = g.parseEl(t)),
                u("LazyLoad", e),
    ...
    c.magnificPopup.registerModule(D, {
        ...
        proto: {
            initRetina: function() {
                var i, s;
                1 < window.devicePixelRatio && (i = g.st.retina,
                s = i.ratio,
                1 < (s = isNaN(s) ? s() : s) && (h("ImageHasSize." + D, function(t, e) {
                    e.img.css({
...
function(t, e) {
    ...
    !function() {
        ...
        e.prototype.init = function() {
            ...
            0 < e.indexOf("lg=" + this.s.galleryId) && (t.index = parseInt(e.split("&slide=")[1], 10),
            g("body").addClass("lg-from-hash"),
            g("body").hasClass("lg-on") || (setTimeout(function() {
                t.build(t.index)
            }),
            ...
            g("body").hasClass("lg-on") || setTimeout(function() {
                ...
                g("body").hasClass("lg-on") || (t.build(t.index),
                g("body").addClass("lg-on"))
            })
        }
        ,
        e.prototype.build = function(t) {
            ...
            1 < e.$items.length ? (e.arrow(),
            setTimeout(function() {
                e.enableDrag(),
                e.enableSwipe()
            }, 50),
            e.s.mousewheel && e.mousewheel()) : e.$slide.on("click.lg", function() {
                e.$el.trigger("onSlideClick.lg")
            }),
            e.counter(),
            e.closeGallery(),
            e.$el.trigger("onAfterOpen.lg"),
            0 < e.s.hideBarsDelay && e.$outer.on("mousemove.lg click.lg touchstart.lg", function() {
        ...
        e.prototype.Builder = function() {
            var t = ""
              ...
              , s = ""
              , o = this;
            for (g("body").append('<div class="lg-backdrop"></div>'),
            g(".lg-backdrop").css("transition-duration", this.s.backdropDuration + "ms"),
            i = 0; i < this.$items.length; i++)
                t += '<div class="lg-item"></div>';
            this.s.controls && 1 < this.$items.length && (e = '<div class="lg-actions"><button type="button" aria-label="Previous slide" class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button type="button" aria-label="Next slide" class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"),
        ...
        e.prototype.setTop = function() {
            var t, e, i;
            "100%" !== this.s.height && (e = ((t = g(window).height()) - parseInt(this.s.height, 10)) / 2,
        ...
        e.prototype.isVideo = function(t, e) {
            ...
            if (!t)
                return i ? {
                    html5: !0
                } : (console.error("lightGallery :- data-src is not provided on slide item " + (e + 1) + ". Please make sure the selector property is properly configured. More info - http://sachinchoolur.github.io/lightGallery/demos/html-markup.html"),
                !1);
        ...
        e.prototype.addHtml = function(t) {
            var e, i, s, o = null;
            this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? e = this.s.dynamicEl[t].subHtmlUrl : o = this.s.dynamicEl[t].subHtml : (i = this.$items.eq(t)).attr("data-sub-html-url") ? e = i.attr("data-sub-html-url") : (o = i.attr("data-sub-html"),
            this.s.getCaptionFromTitleOrAlt && !o && (o = i.attr("title") || i.find("img").first().attr("alt"))),
            e || (null != o ? "." !== (s = o.substring(0, 1)) && "#" !== s || (o = (this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(o) : g(o)).html()) : o = ""),
            ".lg-sub-html" === this.s.appendSubHtmlTo ? e ? this.$outer.find(this.s.appendSubHtmlTo).load(e) : this.$outer.find(this.s.appendSubHtmlTo).html(o) : e ? this.$slide.eq(t).load(e) : this.$slide.eq(t).append(o),
        ...
        e.prototype.preload = function(t) {
            for (var e = 1, i = 1, e = 1; e <= this.s.preload && !(e >= this.$items.length - t); e++)
        ...
        e.prototype.loadContent = function(e, t, i) {
            var s, a, o, n, r, l, c = this, h = !1, d = function(t) {
                ...
                for (var n = g(window).width(), r = 0; r < e.length; r++)
                    if (parseInt(e[r], 10) > n) {
                        a = i[r];
                        break
                    }
            }, u = c.s.dynamic ? (c.s.dynamicEl[e].poster && (h = !0,
            o = c.s.dynamicEl[e].poster),
            r = c.s.dynamicEl[e].html,
            a = c.s.dynamicEl[e].src,
            l = c.s.dynamicEl[e].alt,
            c.s.dynamicEl[e].responsive && d(c.s.dynamicEl[e].responsive.split(",")),
            n = c.s.dynamicEl[e].srcset,
            c.s.dynamicEl[e].sizes) : ((p = c.$items.eq(e)).attr("data-poster") && (h = !0,
            o = p.attr("data-poster")),
            r = p.attr("data-html"),
            a = p.attr("href") || p.attr("data-src"),
            l = p.attr("title") || p.find("img").first().attr("alt"),
            p.attr("data-responsive") && d(p.attr("data-responsive").split(",")),
            n = p.attr("data-srcset"),
            p.attr("data-sizes")), d = !1;
            c.s.dynamic ? c.s.dynamicEl[e].iframe && (d = !0) : "true" === c.$items.eq(e).attr("data-iframe") && (d = !0);
            var p = c.isVideo(a, e);
            if (!c.$slide.eq(e).hasClass("lg-loaded")) {
                if (d ? c.$slide.eq(e).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>') : h ? (d = "",
                d = p && p.youtube ? "lg-has-youtube" : p && p.vimeo ? "lg-has-vimeo" : "lg-has-html5",
                c.$slide.eq(e).prepend('<div class="lg-video-cont ' + d + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + o + '" /></div></div>')) : p ? (c.$slide.eq(e).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'),
                c.$el.trigger("hasVideo.lg", [e, a, r])) : (l = l ? 'alt="' + l + '"' : "",
                c.$slide.eq(e).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" ' + l + ' src="' + a + '" /></div>')),
            ...
            !0 === t && (c.$slide.eq(e).hasClass("lg-complete") ? c.preload(e) : c.$slide.eq(e).find(".lg-object").on("load.lg error.lg", function() {
                c.preload(e)
            }))
        }
        ,
        e.prototype.slide = function(t, e, i, s) {
            var o, n, r, a, l, c = this.$outer.find(".lg-current").index(), h = this;
            h.lGalleryOn && c === t || (o = this.$slide.length,
            n = h.lGalleryOn ? this.s.speed : 0,
            h.lgBusy || (this.s.download && ((r = h.s.dynamic ? !1 !== h.s.dynamicEl[t].downloadUrl && (h.s.dynamicEl[t].downloadUrl || h.s.dynamicEl[t].src) : "false" !== h.$items.eq(t).attr("data-download-url") && (h.$items.eq(t).attr("data-download-url") || h.$items.eq(t).attr("href") || h.$items.eq(t).attr("data-src"))) ? (g("#lg-download").attr("href", r),
            h.$outer.removeClass("lg-hide-download")) : h.$outer.addClass("lg-hide-download")),
            ...
            e ? (this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"),
            2 < o ? (a = t - 1,
            l = t + 1,
            (0 === t && c === o - 1 || t === o - 1 && 0 === c) && (l = 0,
            a = o - 1)) : (a = 0,
            l = 1),
            "prev" === s ? h.$slide.eq(l).addClass("lg-next-slide") : h.$slide.eq(a).addClass("lg-prev-slide"),
            h.$slide.eq(t).addClass("lg-current")) : (h.$outer.addClass("lg-no-trans"),
            ...
            h.lGalleryOn ? (setTimeout(function() {
                h.loadContent(t, !0, 0)
            }, this.s.speed + 50),
            setTimeout(function() {
                h.lgBusy = !1,
                h.$el.trigger("onAfterSlide.lg", [c, t, e, i])
            }, this.s.speed)) : (h.loadContent(t, !0, h.s.backdropDuration),
            h.lgBusy = !1,
            h.$el.trigger("onAfterSlide.lg", [c, t, e, i])),
            h.lGalleryOn = !0,
            this.s.counter && g("#lg-counter-current").text(t + 1)),
            h.index = t)
        }
        ,
        e.prototype.goToNextSlide = function(t) {
            ...
            e.lgBusy || (e.index + 1 < e.$slide.length ? (e.index++,
            e.$el.trigger("onBeforeNextSlide.lg", [e.index]),
            e.slide(e.index, t, !1, "next")) : i ? (e.index = 0,
            e.$el.trigger("onBeforeNextSlide.lg", [e.index]),
            e.slide(e.index, t, !1, "next")) : e.s.slideEndAnimatoin && !t && (e.$outer.addClass("lg-right-end"),
            setTimeout(function() {
        ...
        e.prototype.goToPrevSlide = function(t) {
            var e = this
              , i = e.s.loop;
            t && e.$slide.length < 3 && (i = !1),
            e.lgBusy || (0 < e.index ? (e.index--,
            e.$el.trigger("onBeforePrevSlide.lg", [e.index, t]),
            e.slide(e.index, t, !1, "prev")) : i ? (e.index = e.$items.length - 1,
            e.$el.trigger("onBeforePrevSlide.lg", [e.index, t]),
            e.slide(e.index, t, !1, "prev")) : e.s.slideEndAnimatoin && !t && (e.$outer.addClass("lg-left-end"),
            setTimeout(function() {
        ...
        e.prototype.keyPress = function() {
            ...
            1 < this.$items.length && g(window).on("keyup.lg", function(t) {
                1 < e.$items.length && (37 === t.keyCode && (t.preventDefault(),
                e.goToPrevSlide()),
            ...
            g(window).on("keydown.lg", function(t) {
                ...
                e.$outer.hasClass("lg-thumb-open") ? e.$outer.removeClass("lg-thumb-open") : e.destroy())
            })
        }
        ,
        ...
        e.prototype.arrowDisable = function(t) {
            !this.s.loop && this.s.hideControlOnEnd && (t + 1 < this.$slide.length ? this.$outer.find(".lg-next").removeAttr("disabled").removeClass("disabled") : this.$outer.find(".lg-next").attr("disabled", "disabled").addClass("disabled"),
        ...
        e.prototype.touchMove = function(t, e) {
            ...
            this.setTranslate(g(".lg-prev-slide"), -this.$slide.eq(this.index).width() + t, 0),
            this.setTranslate(g(".lg-next-slide"), this.$slide.eq(this.index).width() + t, 0))
        }
        ,
        ...
        e.prototype.enableSwipe = function() {
            ...
            e.s.enableSwipe && e.doCss() && (e.$slide.on("touchstart.lg", function(t) {
                e.$outer.hasClass("lg-zoomed") || e.lgBusy || (t.preventDefault(),
                e.manageSwipeClass(),
                i = t.originalEvent.targetTouches[0].pageX)
            }),
            e.$slide.on("touchmove.lg", function(t) {
                e.$outer.hasClass("lg-zoomed") || (t.preventDefault(),
                s = t.originalEvent.targetTouches[0].pageX,
                e.touchMove(i, s),
                o = !0)
            }),
            e.$slide.on("touchend.lg", function() {
                e.$outer.hasClass("lg-zoomed") || (o ? (o = !1,
                e.touchEnd(s - i)) : e.$el.trigger("onSlideClick.lg"))
            }))
        }
        ,
        e.prototype.enableDrag = function() {
            ...
            e.s.enableDrag && e.doCss() && (e.$slide.on("mousedown.lg", function(t) {
                e.$outer.hasClass("lg-zoomed") || e.lgBusy || g(t.target).text().trim() || (t.preventDefault(),
                e.manageSwipeClass(),
                i = t.pageX,
                o = !0,
            ...
            g(window).on("mouseup.lg", function(t) {
                n ? (n = !1,
                e.touchEnd(s - i),
                e.$el.trigger("onDragend.lg")) : (g(t.target).hasClass("lg-object") || g(t.target).hasClass("lg-video-play")) && e.$el.trigger("onSlideClick.lg"),
                o && (o = !1,
        ...
        e.prototype.destroy = function(t) {
            var e = this;
            t || (e.$el.trigger("onBeforeClose.lg"),
            g(window).scrollTop(e.prevScrollTop)),
            t && (e.s.dynamic || this.$items.off("click.lg click.lgcustom"),
        ...
        g.fn.lightGallery = function(t) {
            return this.each(function() {
                if (g.data(this, "lightGallery"))
                    ...
                    g.data(this, "lightGallery", new e(this,t))
            })
        }
        ,
...
function(t, e) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = i(t).data("lightGallery"),
            this.$el = i(t),
            !(this.core.$items.length < 2) && (this.core.s = i.extend({}, e, this.core.s),
            this.interval = !1,
            this.fromAuto = !0,
        ...
        t.prototype.init = function() {
            ...
            t.core.s.progressBar && t.core.$outer.find(".lg").append('<div class="lg-progress-bar"><div class="lg-progress"></div></div>'),
            t.progress(),
            t.core.s.autoplay && t.$el.one("onSlideItemLoad.lg.tm", function() {
                t.startlAuto()
            }),
            t.$el.on("onDragstart.lg.tm touchstart.lg.tm", function() {
                t.interval && (t.cancelAuto(),
                t.canceledOnTouch = !0)
            }),
            t.$el.on("onDragend.lg.tm touchend.lg.tm onSlideClick.lg.tm", function() {
                !t.interval && t.canceledOnTouch && (t.startlAuto(),
                t.canceledOnTouch = !1)
            })
        }
        ,
        t.prototype.progress = function() {
            ...
            i.$el.on("onBeforeSlide.lg.tm", function() {
                i.core.s.progressBar && i.fromAuto && (t = i.core.$outer.find(".lg-progress-bar"),
                e = i.core.$outer.find(".lg-progress"),
                i.interval && (e.removeAttr("style"),
                t.removeClass("lg-start"),
                setTimeout(function() {
                    e.css("transition", "width " + (i.core.s.speed + i.core.s.pause) + "ms ease 0s"),
                    t.addClass("lg-start")
                }, 20))),
        ...
        t.prototype.controls = function() {
            var t = this;
            i(this.core.s.appendAutoplayControlsTo).append('<button type="button" aria-label="Toggle autoplay" class="lg-autoplay-button lg-icon"></button>'),
            t.core.$outer.find(".lg-autoplay-button").on("click.lg", function() {
                i(t.core.$outer).hasClass("lg-show-autoplay") ? (t.cancelAuto(),
        ...
        t.prototype.startlAuto = function() {
            var t = this;
            t.core.$outer.find(".lg-progress").css("transition", "width " + (t.core.s.speed + t.core.s.pause) + "ms ease 0s"),
            t.core.$outer.addClass("lg-show-autoplay"),
            t.core.$outer.find(".lg-progress-bar").addClass("lg-start"),
            t.interval = setInterval(function() {
                t.core.index + 1 < t.core.$items.length ? t.core.index++ : t.core.index = 0,
                t.fromAuto = !0,
...
function(t, e) {
    ...
    !function() {
        ...
        function t(t) {
            return this.core = s(t).data("lightGallery"),
            this.$el = s(t),
        ...
        t.prototype.destroy = function() {
            ...
            s(document).off("fullscreenchange.lg webkitfullscreenchange.lg mozfullscreenchange.lg MSFullscreenChange.lg")
        }
        ,
...
function(t) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = r(t).data("lightGallery"),
            this.$el = r(t),
        ...
        t.prototype.init = function() {
            ...
            i.core.s.dynamic)
                for (var n = 0; n < i.core.s.dynamicEl.length; n++)
                    o += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + i.core.s.dynamicEl[n].thumb + '" /></div></span>';
            else
            ...
            (s = i.core.$outer.find(".lg-pager-cont")).on("click.lg touchend.lg", function() {
                var t = r(this);
...
function(t, e) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = a(t).data("lightGallery"),
        ...
        t.prototype.build = function() {
            ...
            function e(t, e, i) {
                ...
                t.youtube || t.vimeo || t.dailymotion ? t.youtube ? s = o.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + t.youtube[1] + "/" + o.core.s.youtubeThumbSize + ".jpg" : e : t.vimeo ? o.core.s.loadVimeoThumbnail ? (s = "//i.vimeocdn.com/video/error_" + r + ".jpg",
                i = t.vimeo[1]) : s = e : t.dailymotion && (s = o.core.s.loadDailymotionThumbnail ? "//www.dailymotion.com/thumbnail/video/" + t.dailymotion[1] : e) : s = e,
                n += '<div data-vimeo-id="' + i + '" class="lg-thumb-item" style="width:' + o.core.s.thumbWidth + "px; height: " + o.core.s.thumbHeight + "; margin-right: " + o.core.s.thumbMargin + 'px"><img src="' + s + '" /></div>',
                i = ""
            }
        ...
        t.prototype.animateThumb = function(t) {
            ...
            if (this.core.s.animateThumb) {
                ...
                this.left = (this.core.s.thumbWidth + this.core.s.thumbMargin) * t - 1 - e,
        ...
        t.prototype.enableThumbDrag = function() {
            ...
            e.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb", function(t) {
                e.thumbTotalWidth > e.thumbOuterWidth && (t.preventDefault(),
                i = t.pageX,
                o = !0,
            ...
            a(window).on("mousemove.lg.thumb", function(t) {
                ...
                (r -= s - i) > e.thumbTotalWidth - e.thumbOuterWidth && (r = e.thumbTotalWidth - e.thumbOuterWidth),
                r < 0 && (r = 0),
                e.setTranslate(r))
            }),
            a(window).on("mouseup.lg.thumb", function() {
                ...
                e.left = r,
                Math.abs(s - i) < e.core.s.swipeThreshold && (e.thumbClickable = !0)) : e.thumbClickable = !0,
                o && (o = !1,
        ...
        t.prototype.enableThumbSwipe = function() {
            ...
            e.core.$outer.find(".lg-thumb").on("touchmove.lg", function(t) {
                ...
                e.$thumbOuter.addClass("lg-dragging"),
                n = e.left,
                (n -= s - i) > e.thumbTotalWidth - e.thumbOuterWidth && (n = e.thumbTotalWidth - e.thumbOuterWidth),
                n < 0 && (n = 0),
                e.setTranslate(n))
            }),
            e.core.$outer.find(".lg-thumb").on("touchend.lg", function() {
                e.thumbTotalWidth > e.thumbOuterWidth && o ? (o = !1,
                e.$thumbOuter.removeClass("lg-dragging"),
                Math.abs(s - i) < e.core.s.swipeThreshold && (e.thumbClickable = !0),
                e.left = n) : e.thumbClickable = !0
            })
        }
        ,
        t.prototype.toogle = function() {
            ...
            t.$thumbOuter.append('<button type="button" aria-label="Toggle thumbnails" class="lg-toogle-thumb lg-icon"></button>'),
        ...
        t.prototype.thumbkeyPress = function() {
            ...
            a(window).on("keydown.lg.thumb", function(t) {
                ...
                e.core.$outer.addClass("lg-thumb-open")) : 40 === t.keyCode && (t.preventDefault(),
                e.core.$outer.removeClass("lg-thumb-open"))
            })
        }
        ,
        t.prototype.destroy = function() {
            this.core.s.thumbnail && 1 < this.core.$items.length && (a(window).off("resize.lg.thumb orientationchange.lg.thumb keydown.lg.thumb"),
...
function(t, e) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = c(t).data("lightGallery"),
            this.$el = c(t),
        ...
        t.prototype.init = function() {
            ...
            s.core.$el.on("hasVideo.lg.tm", function(t, e, i, s) {
                var o = this;
                if (o.core.$slide.eq(e).find(".lg-video").append(o.loadVideo(i, "lg-object", !0, e, s)),
                s)
                    if (o.core.s.videojs)
                        try {
                        ...
                        !o.videoLoaded && o.core.s.autoplayFirstVideo && o.core.$slide.eq(e).find(".lg-html5").get(0).play()
            }
            .bind(this)),
            s.core.$el.on("onAferAppendSlide.lg.tm", function(t, e) {
                e = this.core.$slide.eq(e).find(".lg-video-cont");
                e.hasClass("lg-has-iframe") || (e.css("max-width", this.core.s.videoMaxWidth),
                this.videoLoaded = !0)
            }
            .bind(this)),
            s.core.doCss() && 1 < s.core.$items.length && (s.core.s.enableSwipe || s.core.s.enableDrag) ? s.core.$el.on("onSlideClick.lg.tm", function() {
            ...
            s.core.s.autoplayFirstVideo && s.core.$el.on("onAferAppendSlide.lg.tm", function(t, e) {
                var i;
                s.core.lGalleryOn || (i = s.core.$slide.eq(e),
                setTimeout(function() {
        ...
        t.prototype.loadVideo = function(t, e, i, s, o) {
            ...
            return n = n ? 'title="' + n + '"' : "",
            i && (a = !this.videoLoaded && this.core.s.autoplayFirstVideo ? 1 : 0),
            s.youtube ? (l = "?wmode=opaque&autoplay=" + a + "&enablejsapi=1",
            this.core.s.youtubePlayerParams && (l = l + "&" + c.param(this.core.s.youtubePlayerParams)),
            r = '<iframe class="lg-video-object lg-youtube ' + e + '" ' + n + ' width="560" height="315" src="//www.youtube.com/embed/' + s.youtube[1] + l + '" frameborder="0" allowfullscreen></iframe>') : s.vimeo ? (l = "?autoplay=" + a + "&api=1",
            this.core.s.vimeoPlayerParams && (l = l + "&" + c.param(this.core.s.vimeoPlayerParams)),
            r = '<iframe class="lg-video-object lg-vimeo ' + e + '" ' + n + ' width="560" height="315"  src="//player.vimeo.com/video/' + s.vimeo[1] + l + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>') : s.dailymotion ? (l = "?wmode=opaque&autoplay=" + a + "&api=postMessage",
            this.core.s.dailymotionPlayerParams && (l = l + "&" + c.param(this.core.s.dailymotionPlayerParams)),
            r = '<iframe class="lg-video-object lg-dailymotion ' + e + '" ' + n + ' width="560" height="315" src="//www.dailymotion.com/embed/video/' + s.dailymotion[1] + l + '" frameborder="0" allowfullscreen></iframe>') : s.html5 ? ("." !== (i = o.substring(0, 1)) && "#" !== i || (o = c(o).html()),
            r = o) : s.vk && (l = "&autoplay=" + a,
            this.core.s.vkPlayerParams && (l = l + "&" + c.param(this.core.s.vkPlayerParams)),
            r = '<iframe class="lg-video-object lg-vk ' + e + '" ' + n + ' width="560" height="315" src="//vk.com/video_ext.php?' + s.vk[1] + l + '" frameborder="0" allowfullscreen></iframe>'),
            r
        }
        ,
        t.prototype.loadVideoOnclick = function(i) {
            ...
            if (i.find(".lg-object").hasClass("lg-has-poster") && i.find(".lg-object").is(":visible"))
                if (i.hasClass("lg-has-video")) {
                    ...
                    o = function(t, e) {
                        if (i.find(".lg-video").append(s.loadVideo(t, "", !1, s.core.index, e)),
                        e)
                            if (s.core.s.videojs)
                                try {
                                ...
                                s.core.$slide.eq(s.core.index).find(".lg-html5").get(0).play()
                    }
                    ;
                    ...
                    i.find(".lg-video-object").hasClass("lg-html5") || (i.removeClass("lg-complete"),
...
function(t, e) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = u(t).data("lightGallery"),
        ...
        var e, i, s = {
            ...
            enableZoomAfter: 300,
            useLeftForZoom: (e = !1,
            (i = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)) && parseInt(i[2], 10) < 54 && (e = !0),
            e)
        };
        t.prototype.init = function() {
            var n = this
            ...
            n.core.s.actualSize && (t += '<button type="button" aria-label="Actual size" id="lg-actual-size" class="lg-icon"></button>'),
            n.core.s.useLeftForZoom ? n.core.$outer.addClass("lg-use-left-for-zoom") : n.core.$outer.addClass("lg-use-transition-for-zoom"),
            ...
            n.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(t, e, i) {
                ...
                u("body").hasClass("lg-from-hash") && i ? s = 0 : u("body").removeClass("lg-from-hash"),
            ...
            function e(t) {
                var e = n.core.$outer.find(".lg-current .lg-image")
                  ...
                  , i = (t - 1) * (n.pageX - i)
                  , s = (t - 1) * (n.pageY - s);
                e.css("transform", "scale3d(" + t + ", " + t + ", 1)").attr("data-scale", t),
                (n.core.s.useLeftForZoom ? e.parent().css({
                    left: -i + "px",
                    top: -s + "px"
            ...
            function s(t, e, i, s) {
                ...
                n.core.$outer.hasClass("lg-zoomed") ? a = 1 : o < e && (a = e / o || 2),
                s ? (n.pageX = u(window).width() / 2,
                n.pageY = u(window).height() / 2 + u(window).scrollTop()) : (n.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX,
            ...
            u("#lg-zoom-out").on("click.lg", function() {
                n.core.$outer.find(".lg-current .lg-image").length && (a -= n.core.s.scale,
                r())
            }),
        ...
        t.prototype.getCurrentTransform = function(t) {
            ...
            t = t.getPropertyValue("-webkit-transform") || t.getPropertyValue("-moz-transform") || t.getPropertyValue("-ms-transform") || t.getPropertyValue("-o-transform") || t.getPropertyValue("transform") || "none";
        ...
        t.prototype.getModifier = function(t, e, i) {
            ...
            if (!o)
                return 1;
            var n, i = 1;
            return "X" === e ? (n = Math.sign(parseFloat(o[0])),
            0 === t || 180 === t ? i = 1 : 90 === t && (i = -90 === s && 1 === n || 90 === s && -1 === n ? -1 : 1),
            i *= n) : (n = Math.sign(parseFloat(o[3])),
            0 === t || 180 === t ? i = 1 : 90 === t && (t = parseFloat(o[1]),
            o = parseFloat(o[2]),
            i = Math.sign(t * o * s * n)),
            i *= n),
            i
        ...
        t.prototype.zoomSwipe = function() {
            var s, o = this, n = {}, r = {}, a = !1, l = !1, c = !1, h = 0;
            o.core.$slide.on("touchstart.lg", function(t) {
                var e;
                o.core.$outer.hasClass("lg-zoomed") && (e = o.core.$slide.eq(o.core.index).find(".lg-object"),
                s = o.core.$slide.eq(o.core.index).find(".lg-img-rotate")[0],
                h = o.getCurrentRotation(s),
                e = o.getDragAllowedAxises(e, Math.abs(h)),
                c = e.allowY,
                ((l = e.allowX) || c) && (t.preventDefault(),
                n = o.getSwipeCords(t, Math.abs(h))))
            }),
            o.core.$slide.on("touchmove.lg", function(t) {
                var e, i;
                o.core.$outer.hasClass("lg-zoomed") && (e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap"),
                t.preventDefault(),
                a = !0,
                r = o.getSwipeCords(t, Math.abs(h)),
                o.core.$outer.addClass("lg-zoom-dragging"),
                i = c ? -Math.abs(e.attr("data-y")) + (r.y - n.y) * o.getModifier(h, "Y", s) : -Math.abs(e.attr("data-y")),
                t = l ? -Math.abs(e.attr("data-x")) + (r.x - n.x) * o.getModifier(h, "X", s) : -Math.abs(e.attr("data-x")),
                (15 < Math.abs(r.x - n.x) || 15 < Math.abs(r.y - n.y)) && (o.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)")))
            }),
            o.core.$slide.on("touchend.lg", function() {
                o.core.$outer.hasClass("lg-zoomed") && a && (a = !1,
        ...
        t.prototype.zoomDrag = function() {
            var s, o = this, n = {}, r = {}, a = !1, l = !1, c = !1, h = !1, d = 0;
            o.core.$slide.on("mousedown.lg.zoom", function(t) {
                ...
                h = e.allowY,
                c = e.allowX,
                o.core.$outer.hasClass("lg-zoomed") && u(t.target).hasClass("lg-object") && (c || h) && (t.preventDefault(),
            ...
            u(window).on("mousemove.lg.zoom", function(t) {
                var e, i;
                a && (e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap"),
                l = !0,
                r = o.getDragCords(t, Math.abs(d)),
                o.core.$outer.addClass("lg-zoom-dragging"),
                i = h ? -Math.abs(e.attr("data-y")) + (r.y - n.y) * o.getModifier(d, "Y", s) : -Math.abs(e.attr("data-y")),
                t = c ? -Math.abs(e.attr("data-x")) + (r.x - n.x) * o.getModifier(d, "X", s) : -Math.abs(e.attr("data-x")),
                o.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)"))
            }),
            u(window).on("mouseup.lg.zoom", function(t) {
                a && (a = !1,
                o.core.$outer.removeClass("lg-zoom-dragging"),
                !l || n.x === r.x && n.y === r.y || (r = o.getDragCords(t, Math.abs(d)),
        ...
        t.prototype.touchendZoom = function(t, e, i, s, o) {
            ...
            (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) && (s && (l <= -o.maxY ? l = -o.maxY : l >= -o.minY && (l = -o.minY)),
            i && (c <= -o.maxX ? c = -o.maxX : c >= -o.minX && (c = -o.minX)),
            s ? r.attr("data-y", Math.abs(l)) : l = -Math.abs(r.attr("data-y")),
            i ? r.attr("data-x", Math.abs(c)) : c = -Math.abs(r.attr("data-x")),
            n.core.s.useLeftForZoom ? r.css({
                left: c + "px",
                top: l + "px"
...
function(t, e) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = o(t).data("lightGallery"),
        ...
        t.prototype.init = function() {
            ...
            t += s.core.s.facebook ? '<li><a id="lg-share-facebook" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + "</span></a></li>" : "",
            t += s.core.s.twitter ? '<li><a id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + "</span></a></li>" : "",
            t += s.core.s.pinterest ? '<li><a id="lg-share-pinterest" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + "</span></a></li>" : "",
            t += "</ul></button>",
            this.core.$outer.find(".lg-toolbar").append(t),
            ...
            s.core.$el.on("onAfterSlide.lg.tm", function(t, e, i) {
                setTimeout(function() {
                    o("#lg-share-facebook").attr("href", "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(s.getSahreProps(i, "facebookShareUrl") || window.location.href)),
                    o("#lg-share-twitter").attr("href", "https://twitter.com/intent/tweet?text=" + s.getSahreProps(i, "tweetText") + "&url=" + encodeURIComponent(s.getSahreProps(i, "twitterShareUrl") || window.location.href)),
                    o("#lg-share-pinterest").attr("href", "http://www.pinterest.com/pin/create/button/?url=" + encodeURIComponent(s.getSahreProps(i, "pinterestShareUrl") || window.location.href) + "&media=" + encodeURIComponent(s.getSahreProps(i, "src")) + "&description=" + s.getSahreProps(i, "pinterestText"))
                }, 100)
            })
        }
        ,
        t.prototype.getSahreProps = function(t, e) {
            var i;
            return this.core.s.dynamic ? this.core.s.dynamicEl[t][e] : (i = this.core.$items.eq(t).attr("href"),
...
function(t, e) {
    ...
    !function() {
        ...
        t.prototype.buildTemplates = function() {
            var t = "";
            this.core.s.flipVertical && (t += '<button aria-label="Flip vertical" class="lg-flip-ver lg-icon"></button>'),
            this.core.s.flipHorizontal && (t += '<button aria-label="flip horizontal" class="lg-flip-hor lg-icon"></button>'),
            this.core.s.rotateLeft && (t += '<button aria-label="Rotate left" class="lg-rotate-left lg-icon"></button>'),
            this.core.s.rotateRight && (t += '<button aria-label="Rotate right" class="lg-rotate-right lg-icon"></button>'),
            this.core.$outer.find(".lg-toolbar").append(t)
        }
        ,
        t.prototype.init = function() {
            ...
            this.core.$el.on("onBeforeSlide.lg.tm.rotate", function(t, e, i) {
                s.rotateValuesList[i] || (s.rotateValuesList[i] = {
                    rotate: 0,
                    flipHorizontal: 1,
                    flipVertical: 1
                })
...
function(t) {
    ...
    function e(t) {
        ...
        if ((t = h.event.fix(i)).type = "mousewheel",
        "detail"in i && (r = -1 * i.detail),
        "wheelDelta"in i && (r = i.wheelDelta),
        "wheelDeltaY"in i && (r = i.wheelDeltaY),
        "wheelDeltaX"in i && (n = -1 * i.wheelDeltaX),
        "axis"in i && i.axis === i.HORIZONTAL_AXIS && (n = -1 * r,
        r = 0),
        o = 0 === r ? n : r,
        "deltaY"in i && (o = r = -1 * i.deltaY),
        "deltaX"in i && (n = i.deltaX,
        0 === r && (o = -1 * n)),
        0 !== r || 0 !== n) {
            1 === i.deltaMode ? (o *= e = h.data(this, "mousewheel-line-height"),
            r *= e,
            n *= e) : 2 === i.deltaMode && (o *= e = h.data(this, "mousewheel-page-height"),
            r *= e,
            n *= e);
            var a = Math.max(Math.abs(r), Math.abs(n));
            return g && !(a < g) || u(i, g = a) && (g /= 40),
            u(i, a) && (o /= 40,
            n /= 40,
            r /= 40),
    ...
    var p, g, t = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], i = "onwheel"in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], f = Array.prototype.slice;
    if (h.event.fixHooks)
    ...
    var m = h.event.special.mousewheel = {
        ...
        setup: function() {
            ...
            h.data(this, "mousewheel-page-height", m.getPageHeight(this))
        },
        teardown: function() {
